...
struct APIEndpoint: Hashable {
    ...
    static let registrationEmailResend = APIEndpoint(method: .post, path: "/api/auth/registration-email/resend")
    static let registrationEmailConfirm = APIEndpoint(method: .post, path: "/api/auth/registration-email/confirm")
